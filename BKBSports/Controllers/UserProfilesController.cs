...
namespace BKBSports.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "userId,firstName,lastName,preferredName,dateOfBirth,phoneNumber,profileCreationDate,profileTimestamp,profileImage,profileType")] UserProfile userProfile)
        {
            if (ModelState.IsValid)
            {
